...
module.exports = _extends({
  ...
  FSCollectionImagesPreloader: _reactNativeWeb.Platform.OS == 'android' ? _reactNativeWeb.View : _FSCollectionImagesPreloader2.default,
  ...
  connect: function connect(endpoint, options) {
    ...
    _reactNativeWeb.NetInfo.isConnected.addEventListener('change', function (isConnected) {
