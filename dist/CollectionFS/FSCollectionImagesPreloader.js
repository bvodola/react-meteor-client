...
var FSCollectionImagesPreloader = function (_Component) {
  ...
  function FSCollectionImagesPreloader(props) {
    ...
    var _this = _possibleConstructorReturn(this, (FSCollectionImagesPreloader.__proto__ || Object.getPrototypeOf(FSCollectionImagesPreloader)).call(this, props));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        items && items.map(function (item) {
          return _react2.default.createElement(_reactNativeWeb.Image, { style: styles.hidden, key: item._id, source: { uri: item.url() } });
        })
      );
    }
  }]);
